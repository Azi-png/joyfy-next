...
const TopCourseCard = (props: TopCourseCardProps) => {
				...
				<Box component={'div'} className={'info'}>
					...
					<div className={'options'}>
						<div>
							...
							<span>{course?.courseAge} bed</span>
						</div>
						<div>
							<img src="/img/icons/room.svg" alt="" />
							<span>{course?.courseDuration} rooms</span>
						</div>
						<div>
							<img src="/img/icons/expand.svg" alt="" />
							<span>{course?.courseFormat} m2</span>
						</div>
					</div>
		...
		return (
			<Stack className="top-card-box">
				...
				<Box component={'div'} className={'info'}>
					...
					<Divider sx={{ mt: '15px', mb: '17px' }} />
					<div className={'bott'}>
						<p>{course?.isOffline ? 'Offline Available' : 'Online Only'}</p>
						<div className="view-like-box">
							<IconButton color={'default'}>
								<RemoveRedEyeIcon />
							</IconButton>

...
import { Stack, Box, Pagination, Collapse, IconButton, Typography } from '@mui/material';
						...
						notices.map((ele: any, idx: number) => {
							...
							return (
								<div key={_id ?? `${page}-${idx}`} className="notice-item">
									...
									{/* Dropdown content */}
									<Collapse in={isOpen} timeout="auto" unmountOnExit id={`notice-panel-${_id}`}>
										<Box
											className="notice-panel"
											sx={{ mt: '20px !important', mb: '20px !important', ml: '20px !important' }}
										>
